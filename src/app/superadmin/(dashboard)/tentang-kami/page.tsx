  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-xl font-bold text-text-main dark:text-white">Edit Tentang Kami</h1>
          <p className="text-text-sub dark:text-[#ad92c9] text-sm">Kelola konten yang tampil di halaman Tentang Kami.</p>
        </div>
        <a
          href="/tentang-kami"
          target="_blank"
