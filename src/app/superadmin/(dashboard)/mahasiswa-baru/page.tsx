    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-start sm:items-center gap-3 sm:gap-4">
        ...
        <div className="flex-1 min-w-0">
          <h1 className="text-lg sm:text-xl font-bold text-white">Edit Mahasiswa Baru</h1>
        ...
        <a
          ...
          className="flex items-center gap-1.5 px-3 py-1.5 text-xs sm:text-sm text-[#ad92c9] hover:text-white border border-[#3b2a6e] rounded-lg transition-colors shrink-0"
        >
      ...
      {/* Editor */}
      <div className="bg-[#180f2e] border border-[#3b2a6e] rounded-2xl p-4 sm:p-6">
