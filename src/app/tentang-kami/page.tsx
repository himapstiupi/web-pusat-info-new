      ...
      <main className="flex-1">
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-8 py-12 space-y-24">
          ...
          {(c.kabinet?.nama || c.kabinet?.deskripsi || c.kabinet?.image_url) && (
            <section>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <AnimateOnScroll variant="from-left" className="order-2 lg:order-1">
                ...
                {c.kabinet.image_url && (
                  <AnimateOnScroll variant="from-right" className="order-1 lg:order-2">
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <AnimateOnScroll stagger={1} variant="scale-up">
              <div className="bg-white dark:bg-slate-900 p-10 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm hover:border-primary/50 hover:-translate-y-1 transition-all duration-300 h-full">
            ...
            <AnimateOnScroll stagger={2} variant="scale-up">
              <div className="bg-white dark:bg-slate-900 p-10 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm hover:border-primary/50 hover:-translate-y-1 transition-all duration-300 h-full">
                <div className="w-14 h-14 bg-primary/10 text-primary rounded-xl flex items-center justify-center mb-6">
